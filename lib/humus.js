...
// first interned, avoiding duplication in the IR.
    ...
    function gen_ident_expr(ast, k) {
        ...
        k = as(ast, ir_instr("pick", depths[0],         // ... env ... env
            as(ast, ir_instr("nth", env_nr + 1,         // ... env ... scope
            as(ast, ir_instr("nth", 0,                  // ... env ... value  // TODO
            k))))));
        return k;
    }
...
//debug `);
//debug bad("capture non-existant variable", `
//debug     DEF oops AS neg(x)
//debug `);
...
//debug `);
//debug good("define a constant", `
//debug     DEF x AS 3
//debug     SEND x TO println
//debug `);

//debug const text = "SEND (42, println) TO println";
