...
//debug     loop(42)
//debug `);
//debug good("closure self-reference shadowed by inner variable", `
//debug     DEF x AS \\x.x
//debug `);
//debug // TODO place first DEF in outer block
//debug good("closure self-reference shadows outer variable", `
//debug     DEF x AS 111
//debug     DEF x AS \\y.x
//debug `);
...
//debug const text = `
//debug     DEF x AS \\y.\\z.(x(add(y, 1)))(add(z, 1))
//debug     SEND x(1) TO println
//debug `;
//debug const ir = compile(text);
//debug //log_ir(ir);
//debug log_asm(ir);
