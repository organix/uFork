...
//debug     });
//debug }
//debug function check_good(claim, log_level) {
//debug     const {description, text, expected_print} = claim;
//debug     const ir = compile(text);
...
//debug     }
//debug }
//debug function check_bad(claim, log_level) {
//debug     const {description, text} = claim;
//debug     const ir = compile(text);
//debug     if (ir.errors.length === 0) {
//debug         console.log("FAIL", description);
//debug     }
...
//debug     good.forEach((claim) => check_good(claim, log_level));
//debug     bad.forEach((claim) => check_bad(claim, log_level));
//debug }
...
//debug // check_good(good[5], ufork.LOG_TRACE);
