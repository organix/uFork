...
//debug const seq = [
//debug     'M'.codePointAt(0), 13, 8,
//debug     'l'.codePointAt(0), 144, 42,
//debug     'L'.codePointAt(0), 34, 56,
//debug     'Z'.codePointAt(0),
//debug     'f'.codePointAt(0), 153, 0, 204, 255,
//debug     'D'.codePointAt(0), 102, 204, 51, 255, 3, 1, 1,
//debug ];
