...
//      ...             ; c b a actor
//      roll -(n+1)     ; actor c b a
//      push #nil       ; actor c b a ()
//      roll -(n+1)     ; actor () c b a
//      pair n          ; actor (a b c)
//      roll 2          ; (a b c) actor
//      actor send      ; --
...
//debug     actor create            ; n k=k.cust
//debug     pick 2                  ; n k n
//debug     push 1                  ; n k n 1
//debug     alu sub                 ; n k n-1
//debug     pick 2                  ; n k n-1 k
//debug     pair 1                  ; n k (k . n-1)
//debug     push #?                 ; n k (k . n-1) #?
//debug     push fib_beh            ; n k (k . n-1) #? fib_beh
//debug     actor create            ; n k (k . n-1) fib.#?
//debug     actor send              ; n k
//debug     roll 2                  ; k n
//debug     push 2                  ; k n 2
//debug     alu sub                 ; k n-2
//debug     roll 2                  ; n-2 k
//debug     pair 1                  ; (k . n-2)
//debug     push #?                 ; (k . n-2) #?
//debug     push fib_beh            ; (k . n-2) #? fib_beh
//debug     actor create            ; (k . n-2) fib.#?
//debug     ref std.send_msg
//debug k:                          ; cust <- m
//debug     msg 0                   ; m
//debug     state 0                 ; m cust
//debug     pair 1                  ; (cust . m)
//debug     push k2                 ; (cust . m) k2
//debug     actor become            ; k2.(cust . m)
//debug     ref std.commit
//debug k2:                         ; (cust . m) <- n
//debug     state -1                ; m
//debug     msg 0                   ; m n
//debug     alu add                 ; m+n
//debug     state 1                 ; m+n cust
//debug     ref std.send_msg
//debug .export
//debug     fib_beh
//debug `);
...
//debug     a
//debug `);
//debug bad("missing instruction ref of ref", `
//debug b:
//debug     ref c
//debug a:
//debug     dup 0
//debug     ref b
//debug `);
//debug good("import and label with same name", `
//debug .import
//debug     foo: "foo"
//debug foo:
//debug     ref foo.name
//debug `);
//debug good("deprecated instructions", `
//debug foo:
//debug     new 0
//debug     send 3
//debug     beh -1
//debug     end commit
//debug `);
//debug bad("removed instructions", `
//debug foo:
//debug     new -3
//debug     end commit
//debug `);
