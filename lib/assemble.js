...
// Everything is numbered from zero. We should really use Unicode glyphs for
// this, not UTF-16 characters.
    ...
    return function token_generator() {
        if (rx_token.lastIndex >= text.length) {
            ...
            return {
                ...
                line: end_coordinates.line,
                column: end_coordinates.column
            };
        }
