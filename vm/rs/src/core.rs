...
pub const T_DEQUE_BEH: Any  = Any { raw: T_DEQUE_OFS as Raw };
        ...
        quad_rom[T_DEQUE_OFS+2]     = Quad::vm_deque_new(Any::rom(T_DEQUE_OFS+3));  // (#nil)
        quad_rom[T_DEQUE_OFS+3]     = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+4));  // (#nil) (#nil)
        quad_rom[T_DEQUE_OFS+4]     = Quad::vm_deque_empty(Any::rom(T_DEQUE_OFS+5));  // (#nil) #t
        quad_rom[T_DEQUE_OFS+5]     = Quad::vm_assert(TRUE, Any::rom(T_DEQUE_OFS+6));  // (#nil)

        quad_rom[T_DEQUE_OFS+6]     = Quad::vm_push(PLUS_1, Any::rom(T_DEQUE_OFS+7));  // (#nil) 1
        ...
        quad_rom[T_DEQUE_OFS+18]    = Quad::vm_deque_pull(Any::rom(T_DEQUE_OFS+19));  // (#nil 2 3) 1
        quad_rom[T_DEQUE_OFS+19]    = Quad::vm_assert(PLUS_1, Any::rom(T_DEQUE_OFS+20));  // (#nil 2 3)
        quad_rom[T_DEQUE_OFS+20]    = Quad::vm_deque_pull(Any::rom(T_DEQUE_OFS+21));  // (#nil 3) 2
        quad_rom[T_DEQUE_OFS+21]    = Quad::vm_assert(PLUS_2, Any::rom(T_DEQUE_OFS+22));  // (#nil 3) 2
        quad_rom[T_DEQUE_OFS+22]    = Quad::vm_deque_pull(Any::rom(T_DEQUE_OFS+23));  // (#nil) 3
        quad_rom[T_DEQUE_OFS+23]    = Quad::vm_assert(PLUS_3, Any::rom(T_DEQUE_OFS+24));  // (#nil)
        quad_rom[T_DEQUE_OFS+24]    = Quad::vm_deque_pull(Any::rom(T_DEQUE_OFS+25));  // (#nil) #?
        quad_rom[T_DEQUE_OFS+25]    = Quad::vm_assert(UNDEF, Any::rom(T_DEQUE_OFS+26));  // (#nil)

        quad_rom[T_DEQUE_OFS+26]    = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+27));  // (#nil) (#nil)
        quad_rom[T_DEQUE_OFS+27]    = Quad::vm_deque_len(Any::rom(T_DEQUE_OFS+28));  // (#nil) 0
        quad_rom[T_DEQUE_OFS+28]    = Quad::vm_assert(ZERO, Any::rom(T_DEQUE_OFS+29));  // (#nil)

        quad_rom[T_DEQUE_OFS+29]    = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+30));  // (#nil) (#nil)
        quad_rom[T_DEQUE_OFS+30]    = Quad::vm_msg(ZERO, Any::rom(T_DEQUE_OFS+31));  // (#nil) (#nil) (@4 #t)
        quad_rom[T_DEQUE_OFS+31]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+32));  // (#nil) (#nil (@4 #t))
        quad_rom[T_DEQUE_OFS+32]    = Quad::vm_msg(MINUS_1, Any::rom(T_DEQUE_OFS+33));  // (#nil) (#nil (@4 #t)) (#t)
        quad_rom[T_DEQUE_OFS+33]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+34));  // (#nil) (#nil (#t) (@4 #t))
        quad_rom[T_DEQUE_OFS+34]    = Quad::vm_msg(MINUS_2, Any::rom(T_DEQUE_OFS+35));  // (#nil) (#nil (#t) (@4 #t)) #nil
        quad_rom[T_DEQUE_OFS+35]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+36));  // (#nil) (#nil #nil (#t) (@4 #t))
        quad_rom[T_DEQUE_OFS+36]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+37));  // (#nil) (((#t) #nil)) (@4 #t)
        quad_rom[T_DEQUE_OFS+37]    = Quad::vm_roll(MINUS_2, Any::rom(T_DEQUE_OFS+38));  // (#nil) (@4 #t) (((#t) #nil))
        quad_rom[T_DEQUE_OFS+38]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+39));  // (#nil) (@4 #t) ((#nil)) (#t)
        quad_rom[T_DEQUE_OFS+39]    = Quad::vm_roll(MINUS_3, Any::rom(T_DEQUE_OFS+40));  // (#nil) (#t) (@4 #t) ((#nil))
        quad_rom[T_DEQUE_OFS+40]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+41));  // (#nil) (#t) (@4 #t) (#nil) #nil
        quad_rom[T_DEQUE_OFS+41]    = Quad::vm_assert(NIL, Any::rom(T_DEQUE_OFS+42));  // (#nil) (#t) (@4 #t) (#nil)

        quad_rom[T_DEQUE_OFS+42]    = Quad::vm_push(PLUS_1, Any::rom(T_DEQUE_OFS+43));  // (#nil) (#t) (@4 #t) (#nil) 1
        quad_rom[T_DEQUE_OFS+43]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+44));  // (#nil) (#t) (@4 #t) (#nil 1)
        quad_rom[T_DEQUE_OFS+44]    = Quad::vm_push(PLUS_2, Any::rom(T_DEQUE_OFS+45));  // (#nil) (#t) (@4 #t) (#nil 1) 2
        quad_rom[T_DEQUE_OFS+45]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+46));  // (#nil) (#t) (@4 #t) (#nil 2 1)
        quad_rom[T_DEQUE_OFS+46]    = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+47));  // (#nil) (#t) (@4 #t) (#nil 2 1) (#nil 2 1)
        quad_rom[T_DEQUE_OFS+47]    = Quad::vm_deque_empty(Any::rom(T_DEQUE_OFS+48));  // (#nil) (#t) (@4 #t) (#nil 2 1) #f
        quad_rom[T_DEQUE_OFS+48]    = Quad::vm_assert(FALSE, Any::rom(T_DEQUE_OFS+49));  // (#nil) (#t) (@4 #t) (#nil 2 1)

        quad_rom[T_DEQUE_OFS+49]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+50));  // (#nil) (#t) (@4 #t) ((2)) 1
        quad_rom[T_DEQUE_OFS+50]    = Quad::vm_assert(PLUS_1, Any::rom(T_DEQUE_OFS+51));  // (#nil) (#t) (@4 #t) ((2))
        quad_rom[T_DEQUE_OFS+51]    = Quad::vm_push(PLUS_3, Any::rom(T_DEQUE_OFS+52));  // (#nil) (#t) (@4 #t) ((2)) 3
        quad_rom[T_DEQUE_OFS+52]    = Quad::vm_deque_put(Any::rom(T_DEQUE_OFS+53));  // (#nil) (#t) (@4 #t) ((2) 3)
        quad_rom[T_DEQUE_OFS+53]    = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+54));  // (#nil) (#t) (@4 #t) ((2) 3) ((2) 3)
        quad_rom[T_DEQUE_OFS+54]    = Quad::vm_deque_len(Any::rom(T_DEQUE_OFS+55));  // (#nil) (#t) (@4 #t) ((2) 3) 2
        quad_rom[T_DEQUE_OFS+55]    = Quad::vm_assert(PLUS_2, Any::rom(T_DEQUE_OFS+56));  // (#nil) (#t) (@4 #t) ((2) 3)

        quad_rom[T_DEQUE_OFS+56]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+57));  // (#nil) (#t) (@4 #t) (#nil 3) 2
        quad_rom[T_DEQUE_OFS+57]    = Quad::vm_assert(PLUS_2, Any::rom(T_DEQUE_OFS+58));  // (#nil) (#t) (@4 #t) (#nil 3)
        quad_rom[T_DEQUE_OFS+58]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+59));  // (#nil) (#t) (@4 #t) (#nil) 3
        quad_rom[T_DEQUE_OFS+59]    = Quad::vm_assert(PLUS_3, Any::rom(T_DEQUE_OFS+60));  // (#nil) (#t) (@4 #t) (#nil)
        quad_rom[T_DEQUE_OFS+60]    = Quad::vm_deque_pop(Any::rom(T_DEQUE_OFS+61));  // (#nil) (#t) (@4 #t) (#nil) #?
        quad_rom[T_DEQUE_OFS+61]    = Quad::vm_assert(UNDEF, Any::rom(T_DEQUE_OFS+62));  // (#nil) (#t) (@4 #t) (#nil)
        quad_rom[T_DEQUE_OFS+62]    = Quad::vm_dup(PLUS_1, Any::rom(T_DEQUE_OFS+63));  // (#nil) (#t) (@4 #t) (#nil) (#nil)
        quad_rom[T_DEQUE_OFS+63]    = Quad::vm_deque_len(Any::rom(T_DEQUE_OFS+64));  // (#nil) (#t) (@4 #t) (#nil) 0
        quad_rom[T_DEQUE_OFS+64]    = Quad::vm_assert(ZERO, Any::rom(T_DEQUE_OFS+65));  // (#nil) (#t) (@4 #t) (#nil)
