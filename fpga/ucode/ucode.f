...
0x000c , 0x0001 , 0x0001 , 0x0000 ,  ( ^0004: EMPTY_DQ )
0x0005 , 0x8001 , 0x0000 , 0x0000 ,  ( ^0005: #type_t )
0x0005 , 0x0000 , 0x0000 , 0x0000 ,  ( ^0006: #fixnum_t )
0x0005 , 0x8003 , 0x0000 , 0x0000 ,  ( ^0007: #sponsor_t )
0x0005 , 0x8002 , 0x0000 , 0x0000 ,  ( ^0008: #actor_t )
0x0005 , 0x8002 , 0x0000 , 0x0000 ,  ( ^0009: PROXY_T )
0x0005 , 0x8002 , 0x0000 , 0x0000 ,  ( ^000a: STUB_T )
0x0005 , 0x8003 , 0x0000 , 0x0000 ,  ( ^000b: #instr_t )
0x0005 , 0x8002 , 0x0000 , 0x0000 ,  ( ^000c: #pair_t )
0x0005 , 0x8003 , 0x0000 , 0x0000 ,  ( ^000d: #dict_t )
0x0005 , 0xffff , 0x0000 , 0x0000 ,  ( ^000e: FWD_REF_T )
0x0005 , 0x8000 , 0x0000 , 0x0000 ,  ( ^000f: FREE_T )
: boot_rom
(    T        X        Y        Z       ADDR )
0x000b , 0x8016 , 0x8000 , 0x0011 ,  ( ^0010 )
0x000b , 0x8018 , 0x8000 , 0x0037 ,  ( ^0011 )
0x000b , 0x8003 , 0x0013 , 0x0016 ,  ( ^0012 )
0x000b , 0x8002 , 0x0003 , 0x003e ,  ( ^0013 )
0x000b , 0x8002 , 0x0002 , 0x003f ,  ( ^0014 )
0x000b , 0x8002 , 0x8000 , 0x0040 ,  ( ^0015 )
0x000b , 0x8008 , 0x8000 , 0x0053 ,  ( ^0016 )
0x000b , 0x8018 , 0x8000 , 0x0066 ,  ( ^0017 )
0x000b , 0x8016 , 0x8000 , 0x0018 ,  ( ^0018 )
0x000b , 0x8002 , 0x8000 , 0x001a ,  ( ^0019 )
0x000b , 0x8016 , 0x8001 , 0x0071 ,  ( ^001a )
0x000b , 0x8002 , 0x0000 , 0x0073 ,  ( ^001b )
0x000b , 0x8002 , 0x0000 , 0x0078 ,  ( ^001c )
0x000b , 0x8018 , 0x8000 , 0x0081 ,  ( ^001d )
0x000b , 0x8019 , 0x8000 , 0x0082 ,  ( ^001e )
0x000b , 0x8018 , 0x8000 , 0x0088 ,  ( ^001f )
0x000b , 0x8018 , 0x8000 , 0x008b ,  ( ^0020 )
0x000b , 0x8019 , 0x8000 , 0x0092 ,  ( ^0021 )
0x000b , 0x8018 , 0x8000 , 0x0093 ,  ( ^0022 )
0x000b , 0x8019 , 0x8000 , 0x0097 ,  ( ^0023 )
0x000b , 0x8018 , 0x8000 , 0x00a5 ,  ( ^0024 )
0x000b , 0x8019 , 0x8000 , 0x00ab ,  ( ^0025 )
0x000b , 0x8018 , 0x8001 , 0x00ac ,  ( ^0026 )
0x000b , 0x8019 , 0x8000 , 0x0028 ,  ( ^0027 )
0x000b , 0x8016 , 0x8001 , 0x00af ,  ( ^0028 )
0x000b , 0x8017 , 0x8001 , 0x00b2 ,  ( ^0029 )
0x000b , 0x8018 , 0xffff , 0x00b7 ,  ( ^002a )
0x000b , 0x8018 , 0x8000 , 0x00cd ,  ( ^002b )
0x000b , 0x8019 , 0xffff , 0x00d0 ,  ( ^002c )
0x000b , 0x8002 , 0x8006 , 0x00d3 ,  ( ^002d )
0x000b , 0x8018 , 0x8001 , 0x002f ,  ( ^002e )
0x000b , 0x8009 , 0x8000 , 0x0030 ,  ( ^002f )
0x000b , 0x800f , 0x8001 , 0x0000 ,  ( ^0030 )
0x000b , 0x8009 , 0x8003 , 0x0030 ,  ( ^0031 )
0x000b , 0x8018 , 0x8000 , 0x0033 ,  ( ^0032 )
0x000b , 0x8009 , 0x8004 , 0x002f ,  ( ^0033 )
0x000b , 0x8002 , 0x0000 , 0x0035 ,  ( ^0034 )
0x000b , 0x800f , 0xffff , 0x0000 ,  ( ^0035 )
0x000b , 0x800f , 0x8000 , 0x0000 ,  ( ^0036 )
0x000b , 0x8002 , 0x8000 , 0x0038 ,  ( ^0037 )
0x000b , 0x800a , 0x8001 , 0x0039 ,  ( ^0038 )
0x000b , 0x8002 , 0x8abe , 0x003a ,  ( ^0039 )
0x000b , 0x8014 , 0x8002 , 0x003b ,  ( ^003a )
0x000b , 0x8009 , 0x8000 , 0x003c ,  ( ^003b )
0x000b , 0x8002 , 0x0012 , 0x003d ,  ( ^003c )
0x000b , 0x8009 , 0x8003 , 0x0032 ,  ( ^003d )
0x000b , 0x8019 , 0x8000 , 0x002f ,  ( ^003e )
0x000b , 0x8019 , 0x8000 , 0x002f ,  ( ^003f )
0x000b , 0x8002 , 0x0024 , 0x0041 ,  ( ^0040 )
0x000b , 0x8009 , 0x8002 , 0x0042 ,  ( ^0041 )
0x000b , 0x8002 , 0x8001 , 0x0043 ,  ( ^0042 )
0x000b , 0x8014 , 0x8002 , 0x0044 ,  ( ^0043 )
0x000b , 0x8009 , 0x8000 , 0x0045 ,  ( ^0044 )
0x000b , 0x8002 , 0x8010 , 0x0046 ,  ( ^0045 )
0x000b , 0x8014 , 0x8002 , 0x0047 ,  ( ^0046 )
0x000b , 0x8009 , 0x8000 , 0x0048 ,  ( ^0047 )
0x000b , 0x8002 , 0x8100 , 0x0049 ,  ( ^0048 )
0x000b , 0x8014 , 0x8002 , 0x004a ,  ( ^0049 )
0x000b , 0x8009 , 0x8000 , 0x004b ,  ( ^004a )
0x000b , 0x8019 , 0x8000 , 0x004c ,  ( ^004b )
0x000b , 0x8015 , 0x8002 , 0x004d ,  ( ^004c )
0x000b , 0x8002 , 0x8005 , 0x004e ,  ( ^004d )
0x000b , 0x8011 , 0x8002 , 0x004f ,  ( ^004e )
0x000b , 0x8009 , 0x8004 , 0x0050 ,  ( ^004f )
0x000b , 0x8009 , 0x8000 , 0x0051 ,  ( ^0050 )
0x000b , 0x8002 , 0x8003 , 0x0052 ,  ( ^0051 )
0x000b , 0x8002 , 0x0026 , 0x0031 ,  ( ^0052 )
0x000b , 0x8002 , 0x8200 , 0x0054 ,  ( ^0053 )
0x000b , 0x8008 , 0x8001 , 0x0055 ,  ( ^0054 )
0x000b , 0x8002 , 0x8005 , 0x0056 ,  ( ^0055 )
0x000b , 0x8008 , 0x8002 , 0x0057 ,  ( ^0056 )
0x000b , 0x8002 , 0x8200 , 0x0058 ,  ( ^0057 )
0x000b , 0x8008 , 0x8003 , 0x0059 ,  ( ^0058 )
0x000b , 0x8016 , 0x8001 , 0x005a ,  ( ^0059 )
0x000b , 0x8002 , 0x8004 , 0x005b ,  ( ^005a )
0x000b , 0x8002 , 0x8000 , 0x005c ,  ( ^005b )
0x000b , 0x8002 , 0x0022 , 0x005d ,  ( ^005c )
0x000b , 0x8009 , 0x8002 , 0x005e ,  ( ^005d )
0x000b , 0x8016 , 0x8001 , 0x005f ,  ( ^005e )
0x000b , 0x8019 , 0x8000 , 0x0060 ,  ( ^005f )
0x000b , 0x8011 , 0x8001 , 0x0061 ,  ( ^0060 )
0x000b , 0x8002 , 0x0017 , 0x0062 ,  ( ^0061 )
0x000b , 0x8009 , 0x8003 , 0x0063 ,  ( ^0062 )
0x000b , 0x8009 , 0x8001 , 0x0064 ,  ( ^0063 )
0x000b , 0x8009 , 0x8004 , 0x0065 ,  ( ^0064 )
0x000b , 0x8008 , 0x8005 , 0x0030 ,  ( ^0065 )
0x000b , 0x8010 , 0xfffd , 0x0067 ,  ( ^0066 )
0x000b , 0x8017 , 0x8002 , 0x0068 ,  ( ^0067 )
0x000b , 0x8006 , 0xfff3 , 0x0069 ,  ( ^0068 )
0x000b , 0x8003 , 0x006a , 0x0030 ,  ( ^0069 )
0x000b , 0x8018 , 0x8000 , 0x006b ,  ( ^006a )
0x000b , 0x8002 , 0x800d , 0x006c ,  ( ^006b )
0x000b , 0x8008 , 0x8002 , 0x006d ,  ( ^006c )
0x000b , 0x8009 , 0x8004 , 0x006e ,  ( ^006d )
0x000b , 0x8008 , 0x8005 , 0x006f ,  ( ^006e )
0x000b , 0x8019 , 0x8001 , 0x0070 ,  ( ^006f )
0x000b , 0x8019 , 0xffff , 0x002f ,  ( ^0070 )
0x000b , 0x8002 , 0x8001 , 0x0072 ,  ( ^0071 )
0x000b , 0x800d , 0x8004 , 0x001a ,  ( ^0072 )
0x000b , 0x8009 , 0x8004 , 0x0074 ,  ( ^0073 )
0x000b , 0x8009 , 0x8000 , 0x0075 ,  ( ^0074 )
0x000b , 0x8002 , 0x0000 , 0x0076 ,  ( ^0075 )
0x000b , 0x8009 , 0x8004 , 0x0077 ,  ( ^0076 )
0x000b , 0x8009 , 0x8000 , 0x0030 ,  ( ^0077 )
0x000b , 0x8002 , 0x0000 , 0x0079 ,  ( ^0078 )
0x000b , 0x8002 , 0x001c , 0x007a ,  ( ^0079 )
0x000b , 0x8009 , 0x8002 , 0x007b ,  ( ^007a )
0x000b , 0x8009 , 0x8000 , 0x007c ,  ( ^007b )
0x000b , 0x8002 , 0x0000 , 0x007d ,  ( ^007c )
0x000b , 0x8002 , 0x0000 , 0x007e ,  ( ^007d )
0x000b , 0x8002 , 0x001c , 0x007f ,  ( ^007e )
0x000b , 0x8009 , 0x8002 , 0x0080 ,  ( ^007f )
0x000b , 0x8009 , 0x8000 , 0x0030 ,  ( ^0080 )
0x000b , 0x8002 , 0x001d , 0x0031 ,  ( ^0081 )
0x000b , 0x8005 , 0x0006 , 0x0083 ,  ( ^0082 )
0x000b , 0x8003 , 0x0084 , 0x001f ,  ( ^0083 )
0x000b , 0x8018 , 0x8000 , 0x0085 ,  ( ^0084 )
0x000b , 0x8019 , 0x8000 , 0x0086 ,  ( ^0085 )
0x000b , 0x800e , 0x8001 , 0x0087 ,  ( ^0086 )
0x000b , 0x8003 , 0x0030 , 0x001f ,  ( ^0087 )
0x000b , 0x8002 , 0x8001 , 0x0089 ,  ( ^0088 )
0x000b , 0x800d , 0x8004 , 0x008a ,  ( ^0089 )
0x000b , 0x8009 , 0x8004 , 0x002f ,  ( ^008a )
0x000b , 0x8005 , 0x0008 , 0x008c ,  ( ^008b )
0x000b , 0x8003 , 0x0021 , 0x008d ,  ( ^008c )
0x000b , 0x8019 , 0x8000 , 0x008e ,  ( ^008d )
0x000b , 0x8018 , 0x8000 , 0x008f ,  ( ^008e )
0x000b , 0x800d , 0x8004 , 0x0090 ,  ( ^008f )
0x000b , 0x8002 , 0x0020 , 0x0091 ,  ( ^0090 )
0x000b , 0x8009 , 0x8003 , 0x0032 ,  ( ^0091 )
0x000b , 0x8018 , 0x8000 , 0x002f ,  ( ^0092 )
0x000b , 0x8005 , 0x0006 , 0x0094 ,  ( ^0093 )
0x000b , 0x8003 , 0x0023 , 0x0095 ,  ( ^0094 )
0x000b , 0x8019 , 0x8000 , 0x0096 ,  ( ^0095 )
0x000b , 0x8018 , 0x8000 , 0x002f ,  ( ^0096 )
0x000b , 0x8002 , 0x8001 , 0x0098 ,  ( ^0097 )
0x000b , 0x800d , 0x8004 , 0x0099 ,  ( ^0098 )
0x000b , 0x8002 , 0x0022 , 0x009a ,  ( ^0099 )
0x000b , 0x8009 , 0x8003 , 0x009b ,  ( ^009a )
0x000b , 0x8018 , 0x8000 , 0x009c ,  ( ^009b )
0x000b , 0x8002 , 0x8000 , 0x009d ,  ( ^009c )
0x000b , 0x800e , 0x8004 , 0x009e ,  ( ^009d )
0x000b , 0x8003 , 0x0030 , 0x009f ,  ( ^009e )
0x000b , 0x8018 , 0x8000 , 0x00a0 ,  ( ^009f )
0x000b , 0x8002 , 0x8001 , 0x00a1 ,  ( ^00a0 )
0x000b , 0x800d , 0x8005 , 0x00a2 ,  ( ^00a1 )
0x000b , 0x8009 , 0x8004 , 0x00a3 ,  ( ^00a2 )
0x000b , 0x8016 , 0x8002 , 0x00a4 ,  ( ^00a3 )
0x000b , 0x8009 , 0x8000 , 0x002f ,  ( ^00a4 )
0x000b , 0x8005 , 0x0008 , 0x00a6 ,  ( ^00a5 )
0x000b , 0x8003 , 0x0025 , 0x00a7 ,  ( ^00a6 )
0x000b , 0x8019 , 0x8000 , 0x00a8 ,  ( ^00a7 )
0x000b , 0x8018 , 0x8000 , 0x00a9 ,  ( ^00a8 )
0x000b , 0x800d , 0x8004 , 0x00aa ,  ( ^00a9 )
0x000b , 0x8002 , 0x0024 , 0x0031 ,  ( ^00aa )
0x000b , 0x8018 , 0x8000 , 0x002f ,  ( ^00ab )
0x000b , 0x8003 , 0x0027 , 0x00ad ,  ( ^00ac )
0x000b , 0x8018 , 0xffff , 0x00ae ,  ( ^00ad )
0x000b , 0x8012 , 0x8001 , 0x002f ,  ( ^00ae )
0x000b , 0x8003 , 0x00b0 , 0x0029 ,  ( ^00af )
0x000b , 0x8002 , 0x8001 , 0x00b1 ,  ( ^00b0 )
0x000b , 0x800d , 0x8005 , 0x0028 ,  ( ^00b1 )
0x000b , 0x8018 , 0x8000 , 0x00b3 ,  ( ^00b2 )
0x000b , 0x8012 , 0x8001 , 0x00b4 ,  ( ^00b3 )
0x000b , 0x8002 , 0x8001 , 0x00b5 ,  ( ^00b4 )
0x000b , 0x800d , 0x8005 , 0x00b6 ,  ( ^00b5 )
0x000b , 0x8011 , 0x8001 , 0x0033 ,  ( ^00b6 )
0x000b , 0x8016 , 0x8001 , 0x00b8 ,  ( ^00b7 )
0x000b , 0x8002 , 0x8001 , 0x00b9 ,  ( ^00b8 )
0x000b , 0x800e , 0x8002 , 0x00ba ,  ( ^00b9 )
0x000b , 0x8003 , 0x00bb , 0x002e ,  ( ^00ba )
0x000b , 0x8018 , 0x8001 , 0x00bc ,  ( ^00bb )
0x000b , 0x8002 , 0x002b , 0x00bd ,  ( ^00bc )
0x000b , 0x8009 , 0x8002 , 0x00be ,  ( ^00bd )
0x000b , 0x8014 , 0x8002 , 0x00bf ,  ( ^00be )
0x000b , 0x8002 , 0x8001 , 0x00c0 ,  ( ^00bf )
0x000b , 0x800d , 0x8005 , 0x00c1 ,  ( ^00c0 )
0x000b , 0x8014 , 0x8002 , 0x00c2 ,  ( ^00c1 )
0x000b , 0x8011 , 0x8001 , 0x00c3 ,  ( ^00c2 )
0x000b , 0x8009 , 0x8004 , 0x00c4 ,  ( ^00c3 )
0x000b , 0x8009 , 0x8000 , 0x00c5 ,  ( ^00c4 )
0x000b , 0x8015 , 0x8002 , 0x00c6 ,  ( ^00c5 )
0x000b , 0x8002 , 0x8002 , 0x00c7 ,  ( ^00c6 )
0x000b , 0x800d , 0x8005 , 0x00c8 ,  ( ^00c7 )
0x000b , 0x8015 , 0x8002 , 0x00c9 ,  ( ^00c8 )
0x000b , 0x8011 , 0x8001 , 0x00ca ,  ( ^00c9 )
0x000b , 0x8002 , 0x0000 , 0x00cb ,  ( ^00ca )
0x000b , 0x8002 , 0x002a , 0x00cc ,  ( ^00cb )
0x000b , 0x8009 , 0x8002 , 0x002f ,  ( ^00cc )
0x000b , 0x8019 , 0x8000 , 0x00ce ,  ( ^00cd )
0x000b , 0x8011 , 0x8001 , 0x00cf ,  ( ^00ce )
0x000b , 0x8002 , 0x002c , 0x0031 ,  ( ^00cf )
0x000b , 0x8018 , 0x8000 , 0x00d1 ,  ( ^00d0 )
0x000b , 0x800d , 0x8004 , 0x00d2 ,  ( ^00d1 )
0x000b , 0x8019 , 0x8001 , 0x002f ,  ( ^00d2 )
0x000b , 0x8019 , 0x8000 , 0x00d4 ,  ( ^00d3 )
0x000b , 0x8011 , 0x8001 , 0x00d5 ,  ( ^00d4 )
0x000b , 0x8002 , 0x0000 , 0x00d6 ,  ( ^00d5 )
0x000b , 0x8002 , 0x002a , 0x00d7 ,  ( ^00d6 )
0x000b , 0x8009 , 0x8002 , 0x002f ,  ( ^00d7 )
( 864 cells, 216 quads )
216 CONSTANT rom_quads      ( number of quads in ROM image )
...
0x0004 CONSTANT EMPTY_DQ    ( empty deque )
0x0005 CONSTANT #type_t     ( type of types )
0x0006 CONSTANT #fixnum_t   ( integer fixnum )
0x0007 CONSTANT #sponsor_t  ( resource sponsor )
...
: consume_events ( n_events sponsor -- error )
    DUP root_spn = IF       ( D: n_events sponsor )
        2DROP E_OK ;        ( root sponsor is inexhaustible )
    THEN
...
: cont. ( continuation -- )
    ...
    DUP QT@ raw. SPACE
    DUP QX@ raw. SPACE
    QY@ DUP QX@ DUP raw. ':' EMIT actor. LARROW QY@ raw.
    '}' EMIT ;
...
: actor_become ( sp -- ip' | error )
    ...
    DUP #instr_t typeq IF
        ...
        part                ( D: sp'' state ) ( R: beh )
        R>                  ( D: sp'' state beh )
        effect@ TUCK        ( D: sp'' state effect beh effect )
        qx! qy!             ( D: sp'' )
        update_sp ;
    THEN
    2_not_exe_abort ;
...
: sponsor_memory ( sp -- ip' )
    ...
    2DUP                    ( D: sp' n sponsor n sponsor )
    spn_memory@ fix2int     ( D: sp' n sponsor n spn_mem )
    + int2fix               ( D: sp' n sponsor #n+spn_mem )
    SWAP spn_memory!        ( D: sp' n )
    ( TODO: reduce `sponsor@` memory by `n` )
    DROP                    ( D: sp' )
    update_sp ;
: sponsor_events ( sp -- ip' )
    ...
    nos_sponsor             ( D: sp' n sponsor )
    2DUP                    ( D: sp' n sponsor n sponsor )
    spn_events@ fix2int     ( D: sp' n sponsor n spn_evt )
    + int2fix               ( D: sp' n sponsor #n+spn_evt )
    SWAP spn_events!        ( D: sp' n )
    ( TODO: reduce `sponsor@` events by `n` )
    DROP                    ( D: sp' )
    update_sp ;
: sponsor_cycles ( sp -- ip' )
    ...
    nos_sponsor             ( D: sp' n sponsor )
    2DUP                    ( D: sp' n sponsor n sponsor )
    spn_cycles@ fix2int     ( D: sp' n sponsor n spn_cyc )
    + int2fix               ( D: sp' n sponsor #n+spn_cyc )
    SWAP spn_cycles!        ( D: sp' n )
    ( TODO: reduce `sponsor@` cycles by `n` )
    DROP                    ( D: sp' )
    update_sp ;
...
: dispatch_event ( -- )
    ...
    DUP E_OK <> IF          ( D: event sponsor error )
        ...
        OVER spn_signal!    ( D: event sponsor )
        zq_put ;            ( D: -- )
    ...
    R@ QT@ 3alloc           ( D: event effect ) ( R: target )
    ( create continuation )
...
: ram_init
    ...
    0x8400 root_spn spn_events!
    0x9000 root_spn spn_cycles!
    #? root_quota QZ!
    gc_init ;
