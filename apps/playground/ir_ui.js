...
const ir_ui = make_ui("ir-ui", function (element, {ir}) {
    ...
    function set_ir(new_ir) {
        ir = new_ir;
        pre.textContent = JSON.stringify(new_ir, undefined, 4);
        lang_json.highlight(pre);
    }
...
export default Object.freeze(ir_ui);
